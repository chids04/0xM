...
connectFirestoreEmulator(db, '192.168.1.233', 8081)
connectAuthEmulator(auth, 'http://192.168.1.233:9099', { disableWarnings: true })
connectStorageEmulator(storage, '192.168.1.233', 9199)
